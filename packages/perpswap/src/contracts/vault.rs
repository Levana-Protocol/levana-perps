...
pub struct InstantiateMsg {
    ...
    pub yield_allocation_bps: Vec<u16>,
}
...
pub struct Config {
    ...
    // Address of the factory contract that manages markets
    pub factory_address: Addr,

    // Address of the CW20 contract handling USDCLP tokens
    pub usdclp_address: Addr,
