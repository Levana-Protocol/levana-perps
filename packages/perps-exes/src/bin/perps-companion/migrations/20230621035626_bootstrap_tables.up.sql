...
CREATe TABLE "position_detail"("id" SERIAL8  PRIMARY KEY UNIQUE,"contract_address" INT8 NOT NULL,"chain" VARCHAR(15) NOT NULL,"position_id" BIGINT NOT NULL,"url_id" SERIAL NOT NULL,"pnl_type" VARCHAR(10) NOT NULL);
