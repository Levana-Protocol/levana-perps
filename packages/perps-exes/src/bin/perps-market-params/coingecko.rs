...
impl ExchangeId {
    ...
    pub(crate) fn exchange_type(&self) -> anyhow::Result<ExchangeKind> {
        match self.0 {
            ...
            | 1653 | 11664 | 11665 | 1323 | 11806 | 11921 | 11978 | 11989 | 12030 | 12088
            | 12108 | 12099 | 12131 | 12144 | 1043 | 1518 | 12218 => Ok(ExchangeKind::Cex),
            ...
            | 11216 | 9381 | 7504 | 9391 | 8112 | 11950 | 11952 | 11955 | 10023 | 11953 | 11951
            | 11956 => Ok(ExchangeKind::Dex),
