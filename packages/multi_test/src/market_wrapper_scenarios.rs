...
impl PerpsMarket {
    pub fn new_open_position_long_1(
        ...
        let market = Self::new_with_type(app, DEFAULT_MARKET.collateral_type, true, DEFAULT_MARKET.spot_price)?;
    ...
    pub fn lp_prep(app: Rc<RefCell<PerpsApp>>) -> Result<Self> {
        let market = Self::new_with_type(app, DEFAULT_MARKET.collateral_type, false, DEFAULT_MARKET.spot_price)?;
