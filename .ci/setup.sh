...
### Sibi: Taken from https://github.com/osmosis-labs/osmosis/blob/cf88b689290eb1a94e3d62497c0a8806e872e320/tests/localosmosis/scripts/setup.sh#L1
...
osmosisd add-genesis-account osmo1ssnwszx2dutvlrpwwgefpfyswgrrm059d5mcfe 1000000000000uosmo,1000000000000uion,1000000000000stake --home $OSMOSIS_HOME
